...
MONGOUSERSEED
MONGO_INITDB_ROOT_USERNAME=$MONGO_INITDB_ROOT_USERNAME MONGO_INITDB_ROOT_PASSWORD=$MONGO_INITDB_ROOT_PASSWORD MONGO_INITDB_DATABASE=$MONGO_INITDB_DATABASE MONGO_DATABASE_USERNAME=$MONGO_DATABASE_USERNAME MONGO_DATABASE_PASSWORD=$MONGO_DATABASE_PASSWORD MONGO_DATABASE=$MONGO_DATABASE mongo-user.sh
rm ~/mongo-user.sh
E_USER
