...
cd eAPD/web
npm ci webpack --no-audit --loglevel verbose 2>&1 | /home/ec2-user/npm-webpack-install.log
npm ci --no-audit --loglevel verbose 2>&1 | /home/ec2-user/npm-web-install.log
