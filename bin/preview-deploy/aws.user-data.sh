...
echo "Mongo envs exported: Okta Domain __OKTA_DOMAIN__, MongoDB __MONGO_DATABASE__, and MongoUrl __MONGO_URL__; __MONGO_INITDB_ROOT_USERNAME__ for __MONGO_INITDB_DATABASE__ and __MONGO_DATABASE_USERNAME__ for __MONGO_INITDB_DATABASE__" > mongo-envs.txt
