...
const securityHeaders = {
  ...
  'Content-Security-Policy': `default-src 'self'; script-src 'self' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: ${api} ${okta} https://www.google-analytics.com; font-src 'self' data:; frame-ancestors 'none'; connect-src 'self' ${api} ${okta}`,
