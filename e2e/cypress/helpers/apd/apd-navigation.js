export const testApdNavigation = function () {
  const pages = [
    ...
    },
    {
      ...
      subnav: [
        {
          subtitle: 'APD Overview Summary',
          anchor: '#executive-overview-summary'
        },
        {
          subtitle: 'Activities Summary',
          anchor: '#executive-activities-summary'
        },
        {
          subtitle: 'Program Budget Table',
          anchor: '#executive-summary-budget-table'
        }
      ]
    },
    {
