export const calculateCostsByActivityOrProgramType = ({
  ...
  export const calculateComputableMedicaidCostByFFY = ({ years, activityBudget }) => years.map((year, yearIndex) => ({
      programTypes: {
        HIT: {
  ...
  export const calculateActvityBreakdownByFFYAndActivity = ({ years, activityBudget }) => years.map((year, yearIndex) => ({
    "activities": activityBudget.map(activity => {
      ...
      stateExpenses.['Other Funding Amount'] = activity.expenses[yearIndex].other;
  ...
  export const calculateSummaryBudgetTableByTypeAndFFY = ({ years, activityBudget }) => {
  ...
  export const calculateQuarterlyFederalShareByFFY = ({ years, activityBudget, quarterVals }) => {
