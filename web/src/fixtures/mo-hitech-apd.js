...
const activities = [
  {
    ...
    costAllocationNarrative: {
      ...
      otherSources: '<p>No other funding is provided for this activity.</p>\n'
    },
    description:
    ...
    objectives: [
      {
        ...
        keyResults: [
          {
            baseline: 'incomplete',
            keyResult: 'Complete a build/implementation plan by Summery 2020',
            target: 'complete'
          }
        ],
        key: '550639ed'
...
const apd = {
  data: {
    ...
    state: 'mo',
    status: 'draft',
    updated: 'July 29, 2020, 10:56 AM EDT',
