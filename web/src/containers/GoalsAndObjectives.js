...
import FormGoalsAndObjectives from '../components/FormGoalsAndObjectives';
...
class StateContacts extends Component {
  ...
  render() {
    ...
    return (
      <Box py={4}>
        <FormLogger />
        <Heading mb={3}>Add goals and objectives for Administration</Heading>
        <FormGoalsAndObjectives onSubmit={this.showResults} />
