...
import Icon, { faChevronRight } from '../../components/Icons';
    ...
    <Fragment>
      ...
      >
        ...
        <p className="instruction-box ds-u-font-weight--normal">
          ...
          specifically, products delivered for this activity will be owned by
          the state, and HHS will have a royalty free, non-exclusive, and
          irrevocable license to reproduce, publish, or otherwise use and
          authorize others to use. The costs of the system were determined in
          accordance with 45 CFR 75, subpart E, and this activity will promote
          resuse of systems across our systems enterprise. <br /> Additionally,
          this activity will comply with all of the other conditions of enhanced
          funding except for:
          <br />
      ...
      <RichText
        ...
        value=""
        onChange={() => console.log('yep') /* eslint-disable-line */}
      />
    </Fragment>
  );
    ...
    <Fragment>
      ...
      <div className="ds-u-margin-bottom--6 ds-u-margin-top--3">
        <p className="ds-u-margin-bottom--3">
          Review Medicaid Conditions for Enhanced Funding regulation for the
          criteria that qualifies activities for enhanced funding that pertains
          to various FFP rates.
        </p>
        <HelpDrawerToggle
          helpDrawerOpen={showRegulationDrawer}
          showDrawer={handleDrawerOpen}
        >
          Review Standards and Conditions Regulation{' '}
        ...
        {showRegulationDrawer && (
          <HelpDrawer
            ...
            footerBody={
              <p className="ds-text ds-u-margin--0">
                ...
                <a href="#">Review 42. CFR 433.112 documentation</a>
              </p>
            }
          ...
          >
            <strong>
              Excerpt of 42 CFR 433.112 and Additional Conditions for Enhanced
              Funding
            </strong>
            <p>
              <ol>
                <li>
                  (1) CMS determines the system is likely to provide more
                ...
                <li>
                  ...
                  Medicare for prompt eligibility verification and for
                  processing claims for persons eligible for both programs.
                </li>
                <li>
                  (4) The system supports the data requirements of quality
                  improvement organizations established under Part B of title XI
                  of the Act.
                </li>
                <li>
                ...
                <li>
                  ...
                  software, modifications to software, and documentation that is
                  designed, developed, installed or enhanced with 90 percent
                  FFP.
                </li>
                <li>
                  (7) The costs of the system are determined in accordance with
                  45 CFR 75, subpart E.
                </li>
                <li>
                  (8) The Medicaid agency agrees in writing to use the system
                  for the period of time specified in the advance planning
                  document approved by CMS or for any shorter period of time
                  that CMS determines justifies the Federal funds invested.
                </li>
                <li>
                  (9) The agency agrees in writing that the information in the
                  system will be safeguarded in accordance with subpart F, part
                ...
                <li>
                  ...
                  programming interfaces; the separation of business rules from
                ...
                <li>
                  ...
                  industry standards adopted by the Office of the National
                  Coordinator for Health IT in accordance with 45 CFR part 170,
                  subpart B: The HIPAA privacy, security and transaction
                  standards; accessibility standards established under section
                  508 of the Rehabilitation Act, or standards that provide
                  greater accessibility for individuals with disabilities, and
                  compliance with Federal civil rights laws; standards adopted
                  by the Secretary under section 1104 of the Affordable Care
                  Act; and standards and protocols adopted by the Secretary
                  under section 1561 of the Affordable Care Act.
                </li>
                <li>
                  (13) Promote sharing, leverage, and reuse of Medicaid
                ...
                <li>
                  (15) Produce transaction data, reports, and performance
                  information that would contribute to program evaluation,
                  continuous improvement in business operations, and
                  transparency and accountability.
                </li>
                <li>
                  (16) The system supports seamless coordination and integration
                  with the Marketplace, the Federal Data Services Hub, and
                  allows interoperability with health information exchanges,
                ...
                <li>
                  ...
                  MAGI-based system functionality, demonstrated by performance
                  testing and results based on critical success factors, with
                  limited mitigations and workarounds.
                </li>
                <li>
                  (18) The State must submit plans that contain strategies for
                  reducing the operational consequences of failure to meet
                  applicable requirements for all major milestones and
                  functionality.
                </li>
                <li>
                  (19) The agency, in writing through the APD, must identify key
                  state personnel by name, type and time commitment assigned to
                  each project.
                </li>
                <li>
                  (20) Systems and modules developed, installed or improved with
                  90 percent match must include documentation of components and
                  procedures such that the systems could be operated by a
                ...
                <li>
                  ...
                  strategies to minimize the costs and difficulty of operating
                  the software on alternate hardware or operating systems.
                </li>
                <li>
                  (22) Other conditions for compliance with existing statutory
                  and regulatory requirements, issued through formal guidance
                  procedures, determined by the Secretary to be necessary to
                  update and ensure proper implementation of those existing
                  requirements.
                </li>
              </ol>
            </p>
