    ...
    >
      ...
      >
        ...
        <p className="ds-u-font-weight--normal ds-u-margin-top--1">
          Describe any alternatives considered regarding this activity,
          including how each potential approach was studied or assessed. Provide
          a brief description of each option considered, and a justification for
          the approach or option that was ultimately selected.
        </p>
      </FormLabel>
      <RichText
      ...
      >
        Feasibility Study
        <p className="ds-u-font-weight--normal ds-u-margin-top--1">
          If a feasibility study was conducted for this activity, then the state
          should provide a summary of the results. If the state did not conduct
          a feasibility study, then it should explain why not. Also, the state
          should indicate whether a feasibility study is waived by law or is not
          required in regulation. Note that CMS regulations only allow 50
          percent Federal financial participation (FFP) for feasibility studies.
        </p>
      </FormLabel>
      <RichText
        name="activity overview"
      ...
      >
        ...
        <p className="ds-u-font-weight--normal ds-u-margin-top--1">
          ...
          summary of the analysis and the results. If no requirements analysis
          was conducted, explain the reason. Indicate whether a requirements
          analysis is waived by law or is not required in regulation.
        </p>
      </FormLabel>
      <RichText
        name="activity overview"
      ...
      >
        Forseeable Risks
        <p className="ds-u-font-weight--normal ds-u-margin-top--1">
          Describe any foreseeable risks associated with your proposed solution,
          including the strategy for mitigation of the identified risk(s).
        </p>
        <p className="instruction-box ds-u-font-weight--normal">
          Example: A potential risk to the proposed solution is system outage
          and downtime. The state has determined the risk can be minimized when
          proper precautions are in place and a plan for communications for
          outages has been established. The state accepts this risk and will
          oversee the mitigation efforts through monitoring and oversight of
...
const mapStateToProps = (state, { activityIndex }) => ({ activityIndex });
...
export {
  AlternativeConsiderations as plain,
  mapStateToProps,
  mapDispatchToProps
};
