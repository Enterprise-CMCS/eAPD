...
const QuarterlyBudgetSummary = ({ budget, viewOnly, years }) => {
                ...
                {Object.keys(EXPENSE_NAME_DISPLAY).map(name => (
                  ...
                  >
                    ...
                    <td className="budget-table--total budget-table--number">
                      <Dollars long={viewOnly}>{data.total[name]}</Dollars>
                    </td>
                  </tr>
                ))}
              </tbody>
...
QuarterlyBudgetSummary.defaultProps = { viewOnly: false };
