...
describe('the cost allocation quarterly FFP component', () => {
  ...
  // Can't find a way to test these with shallow/enzyme since we are moving PercentField
  // down the component hierarchy by wrapping them with react-hook-form.
  // TODOL: Replace these tests with react-testing-library
  xit('handles changes to in-house quarterly FFP', () => {
