...
export default {
  title: 'Pages/Apd/Activities/Activity Summary Read-Only',
  component: ActivitySummaryReadOnly,
  includeStories: /.*Story$/,
  parameters: {}
};

const Template = args => <ActivitySummaryReadOnly {...args} />;

export const HitechActivitySummaryStory = Template.bind({});
HitechActivitySummaryStory.args = {
...
export const HitechEmptyActivitySummaryStory = Template.bind({});
HitechEmptyActivitySummaryStory.args = {
  apdType: APD_TYPE.HITECH,
  activity: {
    activityOverview: {
      summary: '',
...
export const MmisActivitySummaryStory = Template.bind({});
MmisActivitySummaryStory.args = {
...
export const MmisActivitySummarySplitStory = Template.bind({});
MmisActivitySummarySplitStory.args = {
  apdType: APD_TYPE.MMIS,
  activity: {
    activityOverview: {
      activitySnapshot:
...
export const MmisEmptyActivitySummaryStory = Template.bind({});
MmisEmptyActivitySummaryStory.args = {
  apdType: APD_TYPE.MMIS,
  activity: {
    activityOverview: {
      activitySnapshot: '',
