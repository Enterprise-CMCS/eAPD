...
const ApdPreviousActivityTableTotalsHITECH = ({ totals }) => {
...
ApdPreviousActivityTableTotalsHITECH.propTypes = {
...
export { ApdPreviousActivityTableTotalsHITECH as plain, mapStateToProps };
