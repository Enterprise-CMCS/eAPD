...
describe('budget reducer', () => {
  ...
  it('loads the budget state', () => {
    ...
    expect(budget(state, { type: LOAD_BUDGET, budget: budgetState })).toEqual(
      budgetState
    );
  });
  ...
  it('loads the budget state', () => {
    ...
    expect(
      budget(state, { type: UPDATE_BUDGET_SUCCESS, budget: budgetState })
    ).toEqual(budgetState);
  });
  ...
  it('loads the budget state', () => {
    ...
    expect(
      budget(state, {
        ...
        data: 'There was an error updating'
      })
    ).toEqual(state);
  });
});
