...
class InstructionStory extends Component {
  ...
  render = () => {
    ...
    return (
      <Fragment>
        ...
        <RenderViewbox>
          <Instruction source="storybook.instruction" reverse={reverse} />
        </RenderViewbox>
  ...
  helpText: >-
    ...
    it covers several lines`}
        ...
        <p>
          The <code>detail</code> and <code>helpText</code> properties are
          treated as Markdown, so they will maintain multiple lines and also
          support simple formatting such as <em>*italics*</em> and{' '}
          <strong>**bold**</strong>
        </p>
        <hr />
        <p>
        ...
        <table className="props">
          ...
          <tr>
            ...
            <td>
              ...
              representing variable names and values to be used for
              replacements. For example, if the localization string is:
              <pre>
