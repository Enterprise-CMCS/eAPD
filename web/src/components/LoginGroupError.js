    ...
    <div id="start-main-content">
      <div className="ds-l-container">
        <div className="login-card login-card__error">
          ...
          <h2 className="ds-h4 ds-u-margin-y--3">Account Error</h2>
          <p>You do not have the correct job codes to access eAPD. Please see the <a href="#">[HELP DOC TITLE]</a> for more guidance.</p>
