...
describe('<NavLink /> (for use within @cms-gov/ds components)', () => {
  it('renders props and children', () => {
    const props = {
      ...
      href: '/apd/0123456789abcdef01234567/executive-summary#executive-summary',
      otherThing: true
    };
    const component = shallow(<NavLink {...props}>Activities Summary</NavLink>);
    expect(component.prop('id')).toEqual('executive-summary-nav');
    expect(component.prop('to')).toEqual(
      '/apd/0123456789abcdef01234567/executive-summary#executive-summary'
    );
