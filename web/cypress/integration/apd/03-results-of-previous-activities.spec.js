...
*/
  ...
  describe('Fill out previous activities page', function ()  {
    ...
    before(function ()  {
      ...
      cy.get('.ds-c-vertical-nav__label--parent').contains('Results of Previous Activities').click();
      // Click on nav submenu button
      cy.get('a.ds-c-vertical-nav__label').contains("Results of Previous Activities").click();
      cy.url().should('contain', '/previous-activities');
      cy.location('pathname').then(pathname => apdPreviousActivitiesURL = pathname);
