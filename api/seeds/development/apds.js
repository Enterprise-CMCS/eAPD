...
const apd = {
  ...
  document: {
    ...
    'activities': [{
      ...
      'fundingSource': 'HIT',
      'outcomes': [{
        'outcome': 'Accept attestations for 2021, and modify SLR to meet new spec sheets released by CMS.',
        'metrics': [{ 'metric': 'Complete SLR modifications by 11/1/21' }, { 'metric': 'Accept attestations through 4/30/22.' }]
      }, {
        'outcome': 'Provide support to EPs and EHs through attestation process.',
        'metrics': [{ 'metric': 'Guidance available on Tycho\'\'s websites' }, { 'metric': 'Office hours availble for EPs and EHs' }, { 'metric': 'Site visits, as needed, for EPs and EHs' }]
      }],
      ...
      }, { 'endDate': '2019-12-31', 'milestone': 'Environmental Scan Completion' }, {
        'endDate': '2021-05-30',
        'milestone': 'HIT Roadmap Development'
      }],
      'standardsAndConditions': {
        'doesNotSupport': '',
        'supports': '<p class="p1"><span class="s1">We will comply with standards and conditions</span></p>'
      },
      'statePersonnel': [{
        ...
        'years': { '2021': { 'amt': 86000, 'perc': 1 }, '2022': { 'amt': 88000, 'perc': 1 } }
      }, {
        'title': 'EHR Incentive Program Meaningful Use Coordinator (Research Analyst III)',
        'description': 'Develop and monitor reports, assist data users in developing and managing queries.',
        'years': { '2021': { 'amt': 101115, 'perc': 1 }, '2022': { 'amt': 102111, 'perc': 1 } }
      }, {
        'title': 'IT Liaison',
        'description': 'Provide analysis and coordination activities between the HIT Program Office and the IT section, to ensure that adequate resources and priority are established to complete the technology projects as identified.',
        'years': { '2021': { 'amt': 101000, 'perc': 1 }, '2022': { 'amt': 104000, 'perc': 1 } }
      }, {
        ...
        'years': { '2021': { 'amt': 101000, 'perc': 3 }, '2022': { 'amt': 109000, 'perc': 3 } }
      }, {
        'title': 'Public Information Officer',
        'description': 'Develop outreach materials including: written, television and radio publications to support outreach for the Medicaid EHR Incentive Program',
        'years': { '2021': { 'amt': 165000, 'perc': 0.5 }, '2022': { 'amt': 170000, 'perc': 0.5 } }
      }, {
        'title': 'Systems Chief',
        'description': 'Coordinate office resources, manage staff, budget, and resource assignments, and report program status.',
        'years': { '2021': { 'amt': 135000, 'perc': 0.5 }, '2022': { 'amt': 140000, 'perc': 0.5 } }
      }, {
        'title': 'Medicaid EHR Incentive Program Manager (Medical Assistance Administrator III)',
        'description': 'Data collection and analysis, reporting, planning, service delivery modification, support administration of the EHR Incentive Payment Program including provider application review.',
        'years': { '2021': { 'amt': 110012, 'perc': 1 }, '2022': { 'amt': 111102, 'perc': 1 } }
      }, {
        'title': 'System Analyst (Analyst Programmer IV)',
        'description': 'Supports design, development and implementation of information technology infrastructure for the projects/programs under the IT Planning office supported by this Implementation Advanced Planning Document.',
        'years': { '2021': { 'amt': 98987, 'perc': 4 }, '2022': { 'amt': 99897, 'perc': 4 } }
      }],
      'summary': 'Continued Operations of the Medicaid EHR Incentive Payment Program, includes modifications to the SLR, HIT staff, auditing, outreach, and non-personnel expenses for administering the program.',
      'quarterlyFFP': {
        '2021': {
      ...
      'statePersonnel': [{
        ...
        'years': { '2021': { 'amt': 98000, 'perc': 1 }, '2022': { 'amt': 99000, 'perc': 1 } }
      }, {
        'title': 'MMIS Project Manager',
        'description': 'This position is responsible for the program development, planning, coordination, evaluation, independent management and oversight of the Tycho Automated Info',
        'years': { '2021': { 'amt': 140000, 'perc': 1 }, '2022': { 'amt': 144000, 'perc': 1 } }
      }, {
        'title': 'MMIS Trainer',
        'description': 'Under the direct supervision of the Project Manager, this position is responsible for the development of a comprehensive training and support program for the Tycho Automated Information Management System',
        'years': { '2021': { 'amt': 115000, 'perc': 1 }, '2022': { 'amt': 115000, 'perc': 1 } }
      }, {
        'title': 'Programmer IV',
        'description': 'The main purpose of this position is to develop and support Web and Client/Server applications. Duties include analysis, design, testing, debugging, documenting and supporting new and existing systems',
        'years': { '2021': { 'amt': 140000, 'perc': 1 }, '2022': { 'amt': 145000, 'perc': 1 } }
      }, {
        'title': 'Security IT',
        'description': 'Make sure its secure.',
        'years': { '2021': { 'amt': 115000, 'perc': 1 }, '2022': { 'amt': 120000, 'perc': 1 } }
      }, {
        'title': 'Operations Specialist',
        'description': 'Run the day to day.',
        'years': { '2021': { 'amt': 125000, 'perc': 1 }, '2022': { 'amt': 130000, 'perc': 1 } }
      }, {
        'title': 'Programmer V',
        'description': 'The main purpose of this position is to develop and support Web and Client/Server applications. Duties include analysis, design, testing, debugging, documenting and supporting new and existing systems',
        'years': { '2021': { 'amt': 150000, 'perc': 2 }, '2022': { 'amt': 155000, 'perc': 3 } }
      }, {
        'title': 'Programmer III',
        'description': 'The main purpose of this position is to develop and support Web and Client/Server applications. Duties include analysis, design, testing, debugging, documenting and supporting new and existing systems',
        'years': { '2021': { 'amt': 120000, 'perc': 1 }, '2022': { 'amt': 125000, 'perc': 1 } }
      }],
      'summary': 'To provide healthcare statistical information and support MU, Tycho plans to interface the MMIS Data Warehouse (DW) to the HIE so that Medicaid claims data can be made available to consumers in their Personal Health Record (PHR) within the HIE. ',
      'quarterlyFFP': {
        '2021': {
          '1': { 'combined': 25, 'contractors': 25, 'inHouse': 25 },
          '2': { 'combined': 25, 'contractors': 25, 'inHouse': 25 },
      ...
      'costAllocationNarrative': { '2021': { 'otherSources': '' }, '2022': { 'otherSources': '' }, 'methodology': '' },
      ...
      'expenses': [{
        'description': 'Training materials creation and software for compliance',
        'category': 'Hardware, software, and licensing',
        'years': { '2021': 10000, '2022': 10000 }
      }],
      'fundingSource': 'HIE',
      'outcomes': [{ 'outcome': 'Onboard 100 providers.', 'metrics': [{ 'metric': '100 providers onboarded.' }] }],
      ...
      }, { 'endDate': '2021-01-01', 'milestone': 'Modules for Care Coordination' }, {
        'endDate': '2022-09-30',
        'milestone': 'Provider Onboarding'
      }, { 'endDate': '2021-10-01', 'milestone': 'EDIE System Implementation' }, {
        'endDate': '2021-12-31',
        'milestone': 'Develop myAlaska HIE Authentication Requirements'
      }, {
        'endDate': '2021-03-31',
        'milestone': 'Completion of requirements gathering to prepare to receive ELR'
      }, {
        'endDate': '2021-12-31',
        'milestone': 'Configuration of internal BizTalk HL7 processes to translate the HL7 messages to PRISM'
      ...
      'statePersonnel': [{
        ...
        'description': 'Lead technical architecture design and development efforts for designing, implementing and maintaining services integrations leveraging resources such as the MCI, MPI and state HIE along with other DHSS Business Systems.',
        'years': { '2021': { 'amt': 115000, 'perc': 4 }, '2022': { 'amt': 119000, 'perc': 4 } }
      }],
      ...
      'schedule': [{ 'endDate': '2021-04-01', 'milestone': 'PHR/Blue Button HIE Build' }, {
        'endDate': '2021-12-31',
        'milestone': 'Blue Button Implementation'
      }, { 'endDate': '2021-12-31', 'milestone': 'On-Boarding of PHR/Blue Button Participants' }],
      ...
      'summary': 'DHSS is requesting HITECH funding to support the onboarding of Medicaid recipients to the developed personal health record (PHR) available within the HIE.',
      'quarterlyFFP': {
        '2021': {
          '1': { 'combined': 25, 'contractors': 25, 'inHouse': 25 },
          '2': { 'combined': 25, 'contractors': 25, 'inHouse': 25 },
    ...
    'federalCitations': {
      ...
      'softwareRights': [{
        ...
        'checked': false,
        'explanation': 'We were able to get better pricing if we allowed the vendor to maintain ownership of the product they developed.'
      }, { 'title': '45 CFR 95.617', 'checked': true, 'explanation': '' }, {
        'title': '42 CFR Part 431.300',
        'checked': true,
        'explanation': ''
      }, { 'title': '42 CFR Part 433.112', 'checked': true, 'explanation': '' }],
      'security': [{ 'title': '45 CFR 164 Securities and Privacy', 'checked': true, 'explanation': '' }]
    },
    'incentivePayments': {
      'ehAmt': {
      ...
      'ehCt': { '2021': { '1': 0, '2': 0, '3': 0, '4': 0 }, '2022': { '1': 0, '2': 0, '3': 0, '4': 0 } },
      'epAmt': { '2021': { '1': 0, '2': 0, '3': 0, '4': 0 }, '2022': { '1': 0, '2': 0, '3': 0, '4': 0 } },
      'epCt': { '2021': { '1': 0, '2': 0, '3': 0, '4': 0 }, '2022': { '1': 0, '2': 0, '3': 0, '4': 0 } }
    },
    'keyPersonnel': [{
      'name': 'James Holden',
