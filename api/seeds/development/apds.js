exports.seed = async knex => {
  ...
  const [apd_id] = await knex('apds') // eslint-disable-line camelcase
    .insert([
      {
        state_id,
        status: 'draft',
        medicaid_director_name: 'Cornelius Fudge',
        medicaid_director_email: 'c.fudge@ministry.magic',
        medicaid_director_phone: '5551234567',
        medicaid_office_address1: '100 Round Sq',
        medicaid_office_city: 'Cityville',
        medicaid_office_state: 'MO',
        medicaid_office_zip: '12345',
        narrative_hie: `<p>Tyco's existing health information infrastructure consists of various organizations operating at the enterprise, local, regional and state levels, and includes:</p>
<ul>
...
<p>Appropriate cost allocation is a fundamental principle of the federal FFP program to ensure that private sector beneficiaries of public investments are covering the incremental cost of their use. A sustainability plan for proportional investments by other payers/providers than Medicaid was developed in concert with the Tycho HIE Board of Directors and a broad cross-section of stakeholders under the leadership of the Tycho HIE Executive Director and State HIT Coordinator. The Tycho HIE’s fee structure and detailed participation agreements can be viewed at: tychoMedicaid.com</p>`,
        narrative_hit: `<p><span style="font-size: 18px;"><strong><ins>Continued Operations of the Medicaid EHR Incentive Payment Program</ins></strong></span></p>
<p></p>
...
<li>Administrative costs: copy paper, office supplies</li>
  ...
  await knex('apd_key_personnel')
    ...
    .returning('id')
    .then(([id]) =>
      knex('apd_key_personnel_yearly').insert([
        {
    ...
    .insert([
      {
        ...
        other_funding_sources_description:
          '<p>No other funding is provided for this activity.</p>\n',
        standards_and_conditions:
          '{"businessResults":"","documentation":"","industryStandards":"","interoperability":"","keyPersonnel":"","leverage":"","minimizeCost":"","mitigationStrategy":"","modularity":"","mita":"","reporting":""}',
        summary:
      ...
      },
      {
        ...
        other_funding_sources_description: null,
        standards_and_conditions:
          '{"businessResults":"","documentation":"","industryStandards":"","interoperability":"","keyPersonnel":"","leverage":"","minimizeCost":"","mitigationStrategy":"","modularity":"","mita":"","reporting":""}',
        summary:
      ...
      },
      {
        ...
        cost_allocation_methodology: null,
        description:
  ...
  await knex('activity_contractor_resources')
    .insert([
      {
  ...
  await knex('activity_expenses')
    ...
    .then(([a, b, c, d, e, f, g, h]) =>
      knex('activity_expense_entries').insert([
        {
          expense_id: a,
          amount: 40000,
          year: '2019'
  ...
  await knex('activity_state_personnel')
    .insert([
      {
        activity_id: activity0,
        description:
    ...
    .returning('id')
    .then(([a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t]) =>
      knex('activity_state_personnel_yearly').insert([
        {
          personnel_id: a,
          id: 9000,
          cost: 86000,
