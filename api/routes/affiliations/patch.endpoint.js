...
describe('Affiliations endpoint | PATCH', () => {
  ...
  describe('/states/all/affiliations:id', () => {
    unauthenticatedTest('patch', '/states/all/affiliations/4000');
    unauthorizedTest('patch', '/states/all/affiliations/4000');
    ...
    it('returns 400 when affiliation id is invalid', async () => {
      const response = await api.patch('/states/all/affiliations/NaN');
      expect(response.status).toEqual(400);
    });
  });

  describe('/states/:state_id/affiliations/:id', () => {
