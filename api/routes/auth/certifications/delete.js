...
const { archiveStateAdminCertification: archiveCertification } = require('../../../db/certifications');
  ...
  app.delete(
    ...
    async (req, res, next) => {
      ...
      try {
        ...
        logger.error({ id: req.id, message: 'error deleting/archiving State Admin Certification' });
