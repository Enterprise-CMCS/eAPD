...
const sanitizeProfile = profile =>{
  ...
  const desiredFields = ['displayName', 'email', 'secondEmail', 'primaryPhone', 'mobilePhone', 'login']
  const cleanProfile = {}
