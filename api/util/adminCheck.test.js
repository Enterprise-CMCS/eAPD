...
const validActivity = {
  ...
  contractorResources: [
    ...
    },
    {
      ...
      hourly: {
        2022: { hours: '4440', rate: '75' },
        2023: { hours: '2500', rate: '80' }
      },
      useHourly: 'true',
...
const invalidHitechActivity = {
  ...
  costAllocation: {
    2022: { ffp: { federal: 90, state: 10, fundingCategory: null }, other: 0 },
    2023: { ffp: { federal: 90, state: 10, fundingCategory: null }, other: 0 }
  },
  costAllocationNarrative: {
    years: {
      2022: {
